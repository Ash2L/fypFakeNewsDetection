...
Errors occur since Github is unable to accomodate larger files, as such when the trained model was uploaded through lfs, the model might become corrupted or incompatibility issues occur when downloaded. Furthermore, some site-packages were removed as the file size was too large.
